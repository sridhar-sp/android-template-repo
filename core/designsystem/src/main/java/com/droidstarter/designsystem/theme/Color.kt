...
/**
 * Download palette colors from here
...
class AppColors(val colorScheme: ColorScheme) {
    // Can Declare Custom colors here use [MaterialTheme.appColors.mainShimmerColor]
    val mainShimmerColor = colorScheme.inverseOnSurface
}